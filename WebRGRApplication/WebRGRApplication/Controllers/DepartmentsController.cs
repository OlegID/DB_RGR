...
namespace WebRGRApplication.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public ActionResult Employees(int? id)
        {
            ...
            var requests = db.Employee.Where(r => r.department_id == id).Include(e => e.Department);
            if (requests == null)
            {
                return HttpNotFound();
            }
        ...
        {
            var result = db.Department.Where(a => a.name.ToLower().Contains(searchText.ToLower()));
            return View(result);
        }
